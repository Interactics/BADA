...
int main(int argc, char ** argv) {
    ...
    //Odometry Inform
    ros::Publisher bada_odom = nh.advertise < nav_msgs::Odometry > (
        "/bada/odom",
        1
    );
    ...
    ros::Publisher bada_MotorR = nh.advertise < std_msgs::Float64 > (
        "/bada/motorR",
        1
    );
    ros::Publisher bada_MotorL = nh.advertise < std_msgs::Float64 > (
        "/bada/motorL",
        1
    );

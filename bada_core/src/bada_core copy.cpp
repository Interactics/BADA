...
void bada_go_to_sound2(){
	...
	goal.target_pose.pose.orientation.z = CURRENT_SOUND_DIRECTION.pose.pose.direction.z
	goal.target_pose.pose.orientation.w = CURRENT_SOUND_DIRECTION.pose.pose.direction.w
	ac.sendGoal(goal);
	return;
}
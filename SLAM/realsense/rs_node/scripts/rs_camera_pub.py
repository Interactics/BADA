...
def talker() :
    ...
    color_bridge = CvBridge() 
    depth_bridge = CvBridge()

    #RealSense Camera setting
    config = rs.config()
    ...
    try:
        ...
        while not rospy.is_shutdown():
            ...
            #removed img
            # imgMsgCol = color_bridge.cv2_to_imgmsg(bg_removed, encoding="bgr8")
            imgMsgCol = color_bridge.cv2_to_imgmsg(color_image, encoding="bgr8")
            imgMsgDep = depth_bridge.cv2_to_imgmsg(depth_image, encoding="16UC1")
